...
$route['reset'] = 'Home/reset_action';
$route['resetpass'] = 'Home/resetpass';
$route['resetnew'] = 'Home/resetnew';
$route['aktivasi'] = 'Home/aktivasi';
...
$route['admin/cetaklaporan'] = 'Laporan/cetaklaporan';
