...
class Mailer {
    protected $_ci;
    protected $email_pengirim = 'xxxxx'; // Isikan dengan email pengirim
    protected $nama_pengirim = 'Admin Saulina'; // Isikan dengan nama pengirim
    protected $password = 'xxxxx'; // Isikan dengan password email pengirim
    ...
    public function send($data){
        ...
        $mail->AddEmbeddedImage('image/logo.png', 'saulina', 'logo.png'); // Aktifkan jika ingin menampilkan gambar dalam email
