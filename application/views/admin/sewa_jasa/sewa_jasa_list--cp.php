                  ...
                  foreach ($sewa_jasa_data->result() as $sewa_jasa)
                  {
                    ...
                    <td style="text-align:center" width="200px">
                       ...
                       <form action="" method="post">
                        ...
                        <a href="#" type="button" class="btn btn-primary" data-toggle="modal" data-target="#myModal<?php  echo $query6->id_pem?>">Konfirmasi</a>
                          ...
                          <div class="modal-dialog" role="document">
                            <div class="modal-content">
                              <div class="modal-header">
                                <h5 class="modal-title" id="exampleModalLabel">Bukti Tf <?php echo $query6->id_pem?></h5>
                                ...
                                <form method="post" action="<?php echo site_url('sewa_jasa/konfirmasi')?>">
                                  <div class="modal-body">
                                    ...
                                    <input type="text" name="biaya" value="<?php echo $query6->biaya?>">
