        ...
        <?php
          ...
          <div class="col-lg-3 col-md-6">
            ...
            <div class="box" data-aos="fade-up" data-aos-delay="100">
               <div>
                <a href="#">
                 <img  style="width: 300px; height: 150px;padding-bottom: 20px" src="<?php echo base_url(); ?>user/produk_dan_jasa/<?php echo $jasa->foto_jasa; ?>" alt="" class="img-fluid">
                </a>
              </div>
              ...
              <div class="btn-wrap">
                <a href="<?php echo site_url('user_login/form_tari/'.$jasa->id_jasa) ?>" class="btn-buy">Sewa</a>
              </div>
            </div>
          </div>
          <?php
