  ...
  <main id="main" style="padding-top: 90px;">
    ...
    <section id="appointment" class="appointment section-bg" >
      <div class="container" data-aos="fade-up">
        ...
        <form action="<?php base_url()?>User_login/aksi_login" method="post"   >
          <div class="form-row" style="padding-left: 300px">
          ...
          <div style="padding-left: 400px">
            <p>jika belum punya akun, silahkan <a href="<?php echo base_url()?>fdaftar">Daftar</a></p>
          </div>
        ...
        <div class="row d-flex">
            <div class="col-lg-6">
                <div class="card1 pb-5">
                    <div class="row"> <img src="<?php echo base_url()?>/assets/img/logo_saulina.png" class="logo"> </div>
                    <div class="row px-3 justify-content-center mt-4 mb-5 border-line"> <img src="<?php echo base_url()?>/assets/f4.jpg" class="image"> </div>
                </div>
            </div>
            <div class="col-lg-6">
